...
function Speedometer(Element) {
  ...
  var Canvas = {
    ...
    label     : TBE.CreateSquareCanvasElement (Size),
  ...
  var Context = {
    ...
    label     : TBE.GetElement2DContext (Canvas.label),
  ...
  Container.appendChild (Canvas.label);
  ...
  {
    var cx = Position.cx, cy = Position.cy;
    var text = options.labelText;
    var context = Context.label;
    console.log(context);
    ...
    context.fillText(text, cx, cy + 100);
  }
